...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "resetWorkspaceColor", combos: [["⌃", "⌥", "0"]], description: { en: "Reset workspace color", ja: "ワークスペース色をリセット" } },
      { id: "setWorkspaceColorRed", combos: [["⌃", "⌥", "1"]], description: { en: "Set workspace color to red", ja: "ワークスペース色を赤に設定" } },
      { id: "setWorkspaceColorCrimson", combos: [["⌃", "⌥", "2"]], description: { en: "Set workspace color to crimson", ja: "ワークスペース色をクリムゾンに設定" } },
      { id: "setWorkspaceColorOrange", combos: [["⌃", "⌥", "3"]], description: { en: "Set workspace color to orange", ja: "ワークスペース色をオレンジに設定" } },
      { id: "setWorkspaceColorAmber", combos: [["⌃", "⌥", "4"]], description: { en: "Set workspace color to amber", ja: "ワークスペース色をアンバーに設定" } },
      { id: "setWorkspaceColorOlive", combos: [["⌃", "⌥", "5"]], description: { en: "Set workspace color to olive", ja: "ワークスペース色をオリーブに設定" } },
      { id: "setWorkspaceColorGreen", combos: [["⌃", "⌥", "6"]], description: { en: "Set workspace color to green", ja: "ワークスペース色を緑に設定" } },
      { id: "setWorkspaceColorTeal", combos: [["⌃", "⌥", "7"]], description: { en: "Set workspace color to teal", ja: "ワークスペース色をティールに設定" } },
      { id: "setWorkspaceColorAqua", combos: [["⌃", "⌥", "8"]], description: { en: "Set workspace color to aqua", ja: "ワークスペース色をアクアに設定" } },
      { id: "setWorkspaceColorBlue", combos: [["⌃", "⌥", "9"]], description: { en: "Set workspace color to blue", ja: "ワークスペース色を青に設定" } },
